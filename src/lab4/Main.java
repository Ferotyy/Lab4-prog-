...
public class Main {
    public static void main(String[] args) {
        try{
            ...
            AirplaneBoard airplaneBoard =new AirplaneBoard("Борт самолета");
            ...
            SnowCylinders snowCylinders = new SnowCylinders("Загадочные снежные циллиндры");
            ...
            Bulletens bulletens = new Bulletens("Бюллетени","посланы", airplaneBoard,flight,meeting,mine,snowCylinders);
            NewsPapers newsPapers = new NewsPapers("Газеты", "напечатали", bulletens);
            Moment moment = new Moment("Момент","наступил");
            We we1 = new We ("Мы", "не могли передавать чувсвтсва");
            ...
            We we3 = new We("Мы", "уже могли расмотреть",tops);
            ...
            We we4 = new We("Мы", "смотрели");
            Us us = new Us("Нас");
            Feeeling feeeling = new Feeeling("Ощущение чуда", "пронизовало", us);
        } catch (Exception e){
